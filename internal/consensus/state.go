...
func (cs *State) AddVote(vote *types.Vote, peerID key.ID) (added bool, err error) {
	if peerID == "" {
...
func (cs *State) SetProposal(proposal *types.Proposal, peerID key.ID) error {
	if peerID == "" {
...
func (cs *State) AddProposalBlockPart(height int64, round int32, part *types.Part, peerID key.ID) error {
	if peerID == "" {
...
func (cs *State) addProposalBlockPart(msg *BlockPartMessage, peerID key.ID) (added bool, err error) {
...
func (cs *State) tryAddVote(vote *types.Vote, peerID key.ID) (bool, error) {
